...
**/
@:native("Uint8Array") extern class Uint8Array_<TArrayBuffer> {
	@:overload(function(array:ArrayLike<Float>):Uint8Array_<js.lib.ArrayBuffer> { })
	@:overload(function<TArrayBuffer>(buffer:TArrayBuffer, ?byteOffset:Float, ?length:Float):Uint8Array_<TArrayBuffer> { })
	...
	@:overload(function(elements:js.lib.Iterable<Float, Dynamic, Dynamic>):Uint8Array_<js.lib.ArrayBuffer> { })
	...
	**/
	...
	/**
		...
		otherwise.
	**/
	@:overload(function(predicate:(value:Float, index:Float, array:Uint8Array_<TArrayBuffer>) -> Any, ?thisArg:Dynamic):Null<Float> { })
	function findLast<S>(predicate:(value:Float, index:Float, array:Uint8Array_<TArrayBuffer>) -> Bool, ?thisArg:Dynamic):Null<S>;
	/**
		Returns the index of the last element in the array where predicate is true, and -1
		otherwise.
	**/
	function findLastIndex(predicate:(value:Float, index:Float, array:Uint8Array_<TArrayBuffer>) -> Any, ?thisArg:Dynamic):Float;
	/**
		Copies the array and returns the copy with the elements in reverse order.
	**/
	function toReversed():Uint8Array_<js.lib.ArrayBuffer>;
	/**
		Copies and sorts the array.
	**/
	function toSorted(?compareFn:(a:Float, b:Float) -> Float):Uint8Array_<js.lib.ArrayBuffer>;
	/**
		Copies the array and inserts the given number at the provided index.
	**/
	function with(index:Float, value:Float):Uint8Array_<js.lib.ArrayBuffer>;
	static final prototype : Uint8Array_<ArrayBufferLike>;
	/**
		The size in bytes of each element in the array.
	**/
	...
	**/
	...
	@:overload(function(elements:js.lib.Iterable<Float, Dynamic, Dynamic>):Uint8Array_<js.lib.ArrayBuffer> { })
	@:overload(function<T>(elements:js.lib.Iterable<T, Dynamic, Dynamic>, ?mapfn:(v:T, k:Float) -> Float, ?thisArg:Dynamic):Uint8Array_<js.lib.ArrayBuffer> { })
