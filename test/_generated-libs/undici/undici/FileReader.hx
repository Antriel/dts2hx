...
@:jsRequire("undici", "FileReader") extern class FileReader {
	function new();
	var __proto__ : Dynamic;
	function readAsArrayBuffer(blob:FileReader):Void;
	function readAsBinaryString(blob:FileReader):Void;
	function readAsText(blob:FileReader, ?encoding:String):Void;
	function readAsDataURL(blob:FileReader):Void;
	function abort():Void;
	final EMPTY : Int;
	final LOADING : Int;
	final DONE : Int;
