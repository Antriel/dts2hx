...
@:jsRequire("undici", "MessageEvent") extern class MessageEvent<T> {
	...
	function initMessageEvent(type:String, ?bubbles:Bool, ?cancelable:Bool, ?data:Dynamic, ?origin:String, ?lastEventId:String, ?source:{ var prototype : node.worker_threads.MessagePort; function listenerCount(emitter:node.events.EventEmitter, event:ts.AnyOf2<String, js.lib.Symbol>):Float; var defaultMaxListeners : Float; }, ?ports:Array<{ var prototype : node.worker_threads.MessagePort; function listenerCount(emitter:node.events.EventEmitter, event:ts.AnyOf2<String, js.lib.Symbol>):Float; var defaultMaxListeners : Float; }>):Void;
	/**
	...
	**/
	...
	static var prototype : MessageEvent<Dynamic>;
}