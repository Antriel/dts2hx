...
typedef DispatchHandlers = {
	...
	**/
	@:optional
	function onUpgrade(statusCode:Float, headers:Null<ts.AnyOf2<Array<String>, Array<global.Buffer>>>, socket:node.stream.Duplex):Void;
	/**
	...
	**/
	@:optional
	function onHeaders(statusCode:Float, headers:Array<global.Buffer>, resume:() -> Void, statusText:String):Bool;
	/**
		Invoked when response payload data is received.
	**/
	@:optional
	function onData(chunk:global.Buffer):Bool;
	/**
