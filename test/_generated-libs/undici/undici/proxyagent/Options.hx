...
typedef Options = {
	...
	@:optional
	var requestTls : undici.buildconnector.BuildOptions;
	@:optional
	var proxyTls : undici.buildconnector.BuildOptions;
	@:optional
	function clientFactory(origin:js.html.URL, opts:Dynamic):undici.Dispatcher;
	/**
		Default: `(origin, opts) => new Pool(origin, opts)`.
	**/
	@:optional
	function factory(origin:ts.AnyOf2<String, node.url.URL>, opts:Dynamic):undici.Dispatcher;
	/**
		Integer. Default: `0`
	**/
	@:optional
	...
	**/
	...
	var interceptors : {
		@:optional
		var Agent : haxe.ds.ReadOnlyArray<undici.dispatcher.DispatchInterceptor>;
	} & {
		@:optional
		var Pool : haxe.ds.ReadOnlyArray<undici.dispatcher.DispatchInterceptor>;
	} & undici.client.OptionsInterceptors;
	/**
	...
	**/
	@:optional
	var connect : ts.AnyOf2<Dynamic, undici.buildconnector.Connector>;
	/**
		TODO
	**/
	@:optional
