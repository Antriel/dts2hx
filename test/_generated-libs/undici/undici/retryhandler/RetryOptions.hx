...
typedef RetryOptions = {
	...
	**/
	@:optional
	dynamic function retry(err:js.lib.Error, context:{ var state : RetryState; var opts : undici.dispatcher.DispatchOptions & { @:optional var retryOptions : RetryOptions; }; }, callback:OnRetryCallback):Void;
	/**
	...
	**/
	@:optional
	var methods : Array<undici.dispatcher.HttpMethod>;
	/**
