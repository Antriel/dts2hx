...
**/
@:native("BigInt64Array") extern class BigInt64Array<TArrayBuffer> {
	@:overload(function(array:ts.AnyOf2<ArrayLike<BigInt>, js.lib.Iterable<BigInt, Dynamic, Dynamic>>):BigInt64Array<js.lib.ArrayBuffer> { })
	@:overload(function<TArrayBuffer>(buffer:TArrayBuffer, ?byteOffset:Float, ?length:Float):BigInt64Array<TArrayBuffer> { })
	@:overload(function(buffer:js.lib.ArrayBuffer, ?byteOffset:Float, ?length:Float):BigInt64Array<js.lib.ArrayBuffer> { })
	@:overload(function(array:ts.AnyOf2<js.lib.ArrayBuffer, ArrayLike<BigInt>>):BigInt64Array<js.lib.ArrayBuffer> { })
	...
	**/
	...
	static final prototype : BigInt64Array<ArrayBufferLike>;
	/**
		The size in bytes of each element in the array.
	**/
	...
	**/
	static function of(items:haxe.extern.Rest<BigInt>):BigInt64Array<js.lib.ArrayBuffer>;
	/**
		Creates an array from an array-like or iterable object.
	**/
	@:overload(function<U>(arrayLike:ArrayLike<U>, mapfn:(v:U, k:Float) -> BigInt, ?thisArg:Dynamic):BigInt64Array<js.lib.ArrayBuffer> { })
	@:overload(function(elements:js.lib.Iterable<BigInt, Dynamic, Dynamic>):BigInt64Array<js.lib.ArrayBuffer> { })
	@:overload(function<T>(elements:js.lib.Iterable<T, Dynamic, Dynamic>, ?mapfn:(v:T, k:Float) -> BigInt, ?thisArg:Dynamic):BigInt64Array<js.lib.ArrayBuffer> { })
	static function from(arrayLike:ArrayLike<BigInt>):BigInt64Array<js.lib.ArrayBuffer>;
}