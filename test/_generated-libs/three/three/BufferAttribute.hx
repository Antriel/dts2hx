...
@:jsRequire("three", "BufferAttribute") extern class BufferAttribute {
	...
	**/
	...
	/**
		...
		holding data stored in the buffer.
	**/
	...
	**/
	...
	/**
		...
		parameter of
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/WebGLRenderingContext/bufferData WebGLRenderingContext.bufferData
		}
		.
	**/
	var usage : Usage;
	...
	**/
	...
	/**
		...
		.
	**/
	function set(value:ts.AnyOf2<js.lib.ArrayBufferView_<js.lib.ArrayBuffer>, js.lib.ArrayLike<Float>>, ?offset:Float):BufferAttribute;
	/**
	...
	**/
	...
	/**
		Convert this object to three.js to the `data.attributes` part of
		{@link
		https://github.com/mrdoob/three.js/wiki/JSON-Geometry-format-4 JSON Geometry format v4
		}
		,
	**/
	function toJSON():BufferAttributeJSON;
