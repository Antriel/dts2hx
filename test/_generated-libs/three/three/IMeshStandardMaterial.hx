...
typedef IMeshStandardMaterial = {
	...
	**/
	...
	/**
		...
		of materials.
	**/
	function setValues(?values:MeshStandardMaterialParameters):Void;
	/**
		This flag can be used for type testing.
	**/
	...
	**/
	function copy(source:Material):MeshStandardMaterial;
	/**
	...
	**/
	function addEventListener<T>(type:T, listener:EventListener<Dynamic, T, MeshStandardMaterial>):Void;
	/**
		Checks if listener is added to an event type.
	**/
	function hasEventListener<T>(type:T, listener:EventListener<Dynamic, T, MeshStandardMaterial>):Bool;
	/**
		Removes a listener from an event type.
	**/
	function removeEventListener<T>(type:T, listener:EventListener<Dynamic, T, MeshStandardMaterial>):Void;
	/**
		Fire an event type.
	**/
