...
/**
	Create a smooth **3D**
	{@link
	http://en.wikipedia.org/wiki/B%C3%A9zier_curve#mediaviewer/File:B%C3%A9zier_2_big.gif quadratic bezier curve
	}
	,
...
@:jsRequire("three", "QuadraticBezierCurve3") extern class QuadraticBezierCurve3 extends Curve<Vector3> {
	...
	**/
	function fromJSON(json:CurveJSON):QuadraticBezierCurve3;
