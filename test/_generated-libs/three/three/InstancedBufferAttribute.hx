...
@:jsRequire("three", "InstancedBufferAttribute") extern class InstancedBufferAttribute extends BufferAttribute {
	...
	**/
	...
	/**
		...
		.
	**/
	final isInstancedBufferAttribute : Bool;
	/**
	...
	**/
	...
	/**
		...
		.
	**/
	function set(value:ts.AnyOf2<js.lib.ArrayBufferView_<js.lib.ArrayBuffer>, js.lib.ArrayLike<Float>>, ?offset:Float):InstancedBufferAttribute;
	/**
