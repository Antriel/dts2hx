...
**/
@:jsRequire("three", "LightShadow") extern class LightShadow<TCamera> {
	/**
	...
	**/
	var map : Null<WebGLRenderTarget<Texture<Any>>>;
	/**
		The distribution map generated using the internal camera; an occlusion is calculated based on the distribution of depths. Computed internally during rendering.
	**/
	var mapPass : Null<WebGLRenderTarget<Texture<Any>>>;
	/**
	...
	**/
	...
	/**
		...
		to `false`, you will need to set this property to `true` and then make a render call to update the light's shadow.
	**/
	...
	**/
	function toJSON():LightShadowJSON;
	/**
