...
@:jsRequire("three", "InterleavedBufferAttribute") extern class InterleavedBufferAttribute {
	...
	**/
	...
	/**
		...
		) attribute has changed and should be re-sent to the GPU.
	**/
	...
	**/
	...
	/**
		...
		to every Vector3 element of this InterleavedBufferAttribute.
	**/
	...
	**/
	...
	/**
		...
		to every Vector3 element of this InterleavedBufferAttribute, interpreting the elements as a direction vectors.
	**/
