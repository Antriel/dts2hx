...
@:jsRequire("three", "Vector3") extern class Vector3 {
	...
	**/
	function sub(v:Vector3Like):Vector3;
	...
	**/
	function cross(v:Vector3Like):Vector3;
	/**
	...
	**/
	...
	/**
		...
		components from the r, g, and b components of the specified
		{@link
		Color color
		}
		.
	...
	**/
	function fromArray(array:ts.AnyOf2<Array<Float>, js.lib.ArrayLike<Float>>, ?offset:Float):Vector3;
	/**
	...
	**/
	...
	function fromBufferAttribute(attribute:ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>, index:Float):Vector3;
	/**
