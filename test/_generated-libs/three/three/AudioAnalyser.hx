...
@:jsRequire("three", "AudioAnalyser") extern class AudioAnalyser {
	...
	**/
	...
	/**
		...
		used to analyze audio.
	**/
	var analyser : js.html.audio.AnalyserNode;
	/**
		A Uint8Array with size determined by
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AnalyserNode/frequencyBinCount analyser.frequencyBinCount
		}
	...
	**/
	...
	/**
		...
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AnalyserNode/getByteFrequencyData getByteFrequencyData
		}
		method
	**/
