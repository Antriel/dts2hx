...
@:jsRequire("three", "Shape") extern class Shape extends Path {
	...
	**/
	...
	/**
		...
		that define the holes in the shape.
	**/
	var holes : Array<Path>;
	/**
		Call
		{@link
		THREE.Curve.getPoints getPoints
		}
		on the
		{@link
		Shape
	...
	**/
	...
	/**
		...
		that represent the holes in the shape.
	**/
	function getPointsHoles(divisions:Float):Array<Array<Vector2>>;
	/**
		Returns a JSON object representation of this instance.
	**/
	function toJSON():ShapeJSON;
	/**
		Copies the data from the given JSON object to this instance.
	**/
	function fromJSON(json:ShapeJSON):Shape;
	/**
	...
	**/
	...
	/**
		...
		to the path, positioned relative to
		{@link
		.currentPoint
		}
		.
	**/
	...
	/**
		This creates a bezier curve from
		{@link
		.currentPoint
		}
		with (cp1X, cp1Y) and (cp2X, cp2Y) as control points and updates
		{@link
		.currentPoint
		}
		to x and y.
	...
	**/
	...
	/**
		Creates a quadratic curve from
		{@link
		.currentPoint
		}
		with cpX and cpY as control point and updates
		{@link
		.currentPoint
		}
		to x and y.
