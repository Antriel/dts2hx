...
/**
	Create a non-positional ( global )
	{@link
	Audio
	}
	object.
	...
	API}.
**/
@:jsRequire("three", "Audio") extern class Audio<NodeType> extends Object3D<Object3DEventMap> {
	/**
	...
	**/
	...
	/**
		...
		created using
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioContext/createGain AudioContext.createGain
		}
		().
	**/
	...
	**/
	...
	/**
		...
		buffer that playback should begin.
		Same as the
		{@link
		Audio.offset
		offset
		...
		parameter of
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/start AudioBufferSourceNode.start()
		}
		.
	**/
	var offset : Float;
	/**
		Overrides the duration of the audio. Same as the
		{@link
		Audio.duration
		duration
		}
	...
	**/
	var isPlaying : Bool;
	/**
		Whether playback can be controlled using the
		{@link
		Audio.play
		play
		}
	...
	**/
	...
	/**
		...
		created using
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioContext/createBufferSource AudioContext.createBufferSource()
		}
		.
	**/
	...
	/**
		...
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioNode AudioNodes
		}
		.
		Can be used to apply a variety of low-order filters to create more complex sound effects.
		In most cases, the array contains instances of
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/BiquadFilterNode BiquadFilterNodes
		}
		.
		Filters are set via
		{@link
		THREE.Audio.setFilter Audio.setFilter
		}
		or
		{@link
		THREE.Audio.setFilters Audio.setFilters
		}
		.
	**/
	...
	**/
	...
	/**
		...
		is enabled, stops playback.
	**/
	function stop(?delay:Float):Audio<NodeType>;
	/**
	...
	**/
	...
	/**
		Connect to the
		{@link
		THREE.Audio.source Audio.source
		}
	**/
	...
	**/
	...
	/**
		Return the value of
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/loop source.loop
		}
	...
	**/
	...
	/**
		Set
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/loopStart source.loopStart
		}
		to `value`.
	**/
	...
	/**
		Set
		{@link
		https://developer.mozilla.org/en-US/docs/Web/API/AudioBufferSourceNode/loopEnd source.loopEnd
		}
		to `value`.
	**/
	...
	**/
	...
	/**
		...
		.
	**/
	function add(object:haxe.extern.Rest<Object3D<Object3DEventMap>>):Audio<NodeType>;
	/**
		Removes a
		{@link
		Object3D
		...
		.
	**/
	function remove(object:haxe.extern.Rest<Object3D<Object3DEventMap>>):Audio<NodeType>;
	/**
	...
	**/
	function attach(object:Object3D<Object3DEventMap>):Audio<NodeType>;
	/**
	...
	**/
	function copy(object:Object3D<Object3DEventMap>, ?recursive:Bool):Audio<NodeType>;
	/**
		Adds a listener to an event type.
	**/
	function addEventListener<T>(type:T, listener:EventListener<Dynamic, T, Audio<NodeType>>):Void;
	/**
		Checks if listener is added to an event type.
	**/
	function hasEventListener<T>(type:T, listener:EventListener<Dynamic, T, Audio<NodeType>>):Bool;
	/**
		Removes a listener from an event type.
	**/
	function removeEventListener<T>(type:T, listener:EventListener<Dynamic, T, Audio<NodeType>>):Void;
