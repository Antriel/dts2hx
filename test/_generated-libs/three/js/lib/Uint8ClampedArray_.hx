...
@:native("Uint8ClampedArray") extern class Uint8ClampedArray_<TArrayBuffer> {
	@:overload(function(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	@:overload(function<TArrayBuffer>(unknown:Dynamic):Uint8ClampedArray_<TArrayBuffer> { })
	@:overload(function(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	@:overload(function(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	@:overload(function(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	...
	**/
	static function of(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer>;
	/**
		Creates an array from an array-like or iterable object.
	**/
	@:overload(function<T>(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	@:overload(function(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	@:overload(function<T>(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer> { })
	static function from(unknown:Dynamic):Uint8ClampedArray_<js.lib.ArrayBuffer>;
}