...
typedef IOffscreenCanvasRenderingContext2D = {
	...
	**/
	@:overload(function(x:Float, y:Float, w:Float, h:Float, ?radii:ts.AnyOf3<Float, js.html.DOMPointInit, js.lib.Iterable<ts.AnyOf2<Float, js.html.DOMPointInit>, Dynamic, Dynamic>>):Void { })
	...
	**/
	@:overload(function(segments:js.lib.Iterable<Float, Dynamic, Dynamic>):Void { })
