...
typedef StringChain<T> = {
	...
	dynamic function each(unknown:Dynamic):StringChain<String>;
	dynamic function eachRight(unknown:Dynamic):StringChain<String>;
	...
	function forEach(unknown:Dynamic):StringChain<String>;
	function forEachRight(unknown:Dynamic):StringChain<String>;
	...
	function clone(unknown:Dynamic):StringChain<T>;
	function cloneDeep(unknown:Dynamic):StringChain<T>;
	@:overload(function(unknown:Dynamic):StringChain<T> { })
	...
	function forIn(unknown:Dynamic):StringChain<T>;
	function forInRight(unknown:Dynamic):StringChain<T>;
	function forOwn(unknown:Dynamic):StringChain<T>;
	function forOwnRight(unknown:Dynamic):StringChain<T>;
	...
	function set(unknown:Dynamic):StringChain<T>;
	@:overload(function<TResult>(unknown:Dynamic):ExpChain<TResult> { })
	function setWith(unknown:Dynamic):StringChain<T>;
	...
	function chain(unknown:Dynamic):StringChain<T>;
	function commit(unknown:Dynamic):StringChain<T>;
	function plant(unknown:Dynamic):StringChain<T>;
	function reverse(unknown:Dynamic):StringChain<T>;
	function toJSON(unknown:Dynamic):T;
	function value(unknown:Dynamic):T;
	function valueOf(unknown:Dynamic):T;
	function tap(unknown:Dynamic):StringChain<T>;
	...
	function bindAll(unknown:Dynamic):StringChain<T>;
	...
	function identity(unknown:Dynamic):StringChain<T>;
	...
	function mixin(unknown:Dynamic):StringChain<T>;
