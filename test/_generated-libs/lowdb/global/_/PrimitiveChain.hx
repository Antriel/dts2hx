...
typedef PrimitiveChain<T> = {
	...
	function after<TFunc>(unknown:Dynamic):FunctionChain<TFunc>;
	function before<TFunc>(unknown:Dynamic):FunctionChain<TFunc>;
	...
	function clone(unknown:Dynamic):PrimitiveChain<T>;
	function cloneDeep(unknown:Dynamic):PrimitiveChain<T>;
	@:overload(function(unknown:Dynamic):PrimitiveChain<T> { })
	...
	function forIn(unknown:Dynamic):PrimitiveChain<T>;
	function forInRight(unknown:Dynamic):PrimitiveChain<T>;
	function forOwn(unknown:Dynamic):PrimitiveChain<T>;
	function forOwnRight(unknown:Dynamic):PrimitiveChain<T>;
	...
	function set(unknown:Dynamic):PrimitiveChain<T>;
	@:overload(function<TResult>(unknown:Dynamic):ExpChain<TResult> { })
	function setWith(unknown:Dynamic):PrimitiveChain<T>;
	...
	function commit(unknown:Dynamic):PrimitiveChain<T>;
	function plant(unknown:Dynamic):PrimitiveChain<T>;
	function reverse(unknown:Dynamic):PrimitiveChain<T>;
	function toJSON(unknown:Dynamic):T;
	function value(unknown:Dynamic):T;
	function valueOf(unknown:Dynamic):T;
	function tap(unknown:Dynamic):PrimitiveChain<T>;
	...
	function bindAll(unknown:Dynamic):PrimitiveChain<T>;
	...
	function identity(unknown:Dynamic):PrimitiveChain<T>;
	...
	function mixin(unknown:Dynamic):PrimitiveChain<T>;
