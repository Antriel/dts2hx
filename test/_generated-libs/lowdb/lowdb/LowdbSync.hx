...
typedef LowdbSync<SchemaT> = {
	...
	dynamic function read(unknown:Dynamic):LowdbSync<SchemaT>;
	function write<T>(unknown:Dynamic):Dynamic;
	dynamic function getState(unknown:Dynamic):SchemaT;
	dynamic function setState(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function updateWith(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function clone(unknown:Dynamic):LowdbSync<SchemaT>;
	function cloneDeep(unknown:Dynamic):LowdbSync<SchemaT>;
	@:overload(function(unknown:Dynamic):LowdbSync<SchemaT> { })
	...
	function forIn(unknown:Dynamic):LowdbSync<SchemaT>;
	function forInRight(unknown:Dynamic):LowdbSync<SchemaT>;
	function forOwn(unknown:Dynamic):LowdbSync<SchemaT>;
	function forOwnRight(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	@:overload(function<TResult>(unknown:Dynamic):lodash.ExpChain<TResult> { })
	function set(unknown:Dynamic):LowdbSync<SchemaT>;
	@:overload(function<TResult>(unknown:Dynamic):lodash.ExpChain<TResult> { })
	function setWith(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function chain(unknown:Dynamic):LowdbSync<SchemaT>;
	function commit(unknown:Dynamic):LowdbSync<SchemaT>;
	function plant(unknown:Dynamic):LowdbSync<SchemaT>;
	function reverse(unknown:Dynamic):LowdbSync<SchemaT>;
	function toJSON(unknown:Dynamic):SchemaT;
	function value(unknown:Dynamic):SchemaT;
	function valueOf(unknown:Dynamic):SchemaT;
	function tap(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function bindAll(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function identity(unknown:Dynamic):LowdbSync<SchemaT>;
	...
	function mixin(unknown:Dynamic):LowdbSync<SchemaT>;
