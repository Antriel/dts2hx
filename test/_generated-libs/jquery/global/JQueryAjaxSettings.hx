...
typedef JQueryAjaxSettings = {
	...
	**/
	@:optional
	var complete : global.jquery.TypeOrArray<global.jquery.ajax.CompleteCallback<Dynamic>>;
	/**
	...
	**/
	@:optional
	var converters : global.jquery.PlainObject<ts.AnyOf2<Bool, (unknown:Dynamic) -> Dynamic>>;
	/**
	...
	**/
	@:optional
	var error : global.jquery.TypeOrArray<global.jquery.ajax.ErrorCallback<Dynamic>>;
	/**
	...
	**/
	@:optional
	var success : global.jquery.TypeOrArray<global.jquery.ajax.SuccessCallback<Dynamic>>;
	/**
