...
**/
typedef PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN> = {
	/**
		Add handlers to be called when the Deferred object is either resolved or rejected.
	**/
	function always(unknown:Dynamic):PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN>;
	/**
		Add handlers to be called when the Deferred object is resolved.
	**/
	function done(unknown:Dynamic):PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN>;
	/**
		Add handlers to be called when the Deferred object is rejected.
	**/
	function fail(unknown:Dynamic):PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN>;
	/**
		Add handlers to be called when the Deferred object generates progress notifications.
	**/
	function progress(unknown:Dynamic):PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN>;
	/**
		Return a Deferred's Promise object.
	**/
	@:overload(function(unknown:Dynamic):PromiseBase<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, SR, SJ, SN> { })
