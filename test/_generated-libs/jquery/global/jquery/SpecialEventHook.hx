...
typedef SpecialEventHook<TTarget, TData> = ts.AnyOf13<{
	...
	**/
	function setup(unknown:Dynamic):Bool;
}, {
	/**
	...
	**/
	function teardown(unknown:Dynamic):Bool;
}, {
	/**
	...
	**/
	function trigger(unknown:Dynamic):Bool;
}, {
	/**
	...
	**/
	function _default(unknown:Dynamic):Bool;
}, {
	/**
	...
	**/
	...
	function preDispatch(unknown:Dynamic):Bool;
}, {
	function postDispatch(unknown:Dynamic):Void;
