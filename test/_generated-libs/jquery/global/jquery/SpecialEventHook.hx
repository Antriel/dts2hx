...
typedef SpecialEventHook<TTarget, TData> = ts.AnyOf13<{
	...
	**/
	function setup(data:TData, namespaces:String, eventHandle:EventHandler<TTarget, TData>):Bool;
}, {
	/**
	...
	**/
	function trigger(event:Event, data:TData):Bool;
}, {
	/**
	...
	**/
	function _default(event:TriggeredEvent<TTarget, TData, Dynamic, Dynamic>, data:TData):Bool;
}, {
	/**
	...
	**/
	...
	function preDispatch(event:Event):Bool;
}, {
