...
typedef Promise<TR, TJ, TN> = {
	...
	**/
	function always(unknown:Dynamic):Promise<TR, TJ, TN>;
	/**
		Add handlers to be called when the Deferred object is resolved.
	**/
	function done(unknown:Dynamic):Promise<TR, TJ, TN>;
	/**
		Add handlers to be called when the Deferred object is rejected.
	**/
	function fail(unknown:Dynamic):Promise<TR, TJ, TN>;
	/**
		Add handlers to be called when the Deferred object generates progress notifications.
	**/
	function progress(unknown:Dynamic):Promise<TR, TJ, TN>;
	/**
