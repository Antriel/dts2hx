...
**/
typedef Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN> = {
	/**
		Add handlers to be called when the Deferred object is either resolved or rejected.
	**/
	function always(unknown:Dynamic):Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN>;
	/**
		Add handlers to be called when the Deferred object is resolved.
	**/
	function done(unknown:Dynamic):Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN>;
	/**
		Add handlers to be called when the Deferred object is rejected.
	**/
	function fail(unknown:Dynamic):Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN>;
	/**
		Add handlers to be called when the Deferred object generates progress notifications.
	**/
	function progress(unknown:Dynamic):Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN>;
	/**
		Return a Deferred's Promise object.
	**/
	@:overload(function(unknown:Dynamic):Promise3<TR, TJ, TN, UR, UJ, UN, VR, VJ, VN> { })
