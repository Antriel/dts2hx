...
typedef UrlAjaxSettings<TContext> = {
	/**
	...
	**/
	@:optional
	function beforeSend(unknown:Dynamic):Bool;
	/**
	...
	**/
	@:optional
	var converters : PlainObject<ts.AnyOf2<Bool, (unknown:Dynamic) -> Dynamic>>;
	/**
	...
	**/
	@:optional
	function dataFilter(unknown:Dynamic):Dynamic;
	/**
	...
	**/
	@:optional
	var error : TypeOrArray<global.jquery.ajax.ErrorCallback<TContext>>;
	/**
	...
	**/
	@:optional
	var jsonpCallback : ts.AnyOf2<String, (unknown:Dynamic) -> String>;
	/**
	...
	**/
	@:optional
	var statusCode : global.jquery.ajax.StatusCodeCallbacks<TContext>;
	/**
		A function to be called if the request succeeds. The function gets passed three arguments: The data returned from the server, formatted according to the dataType parameter or the dataFilter callback function, if specified; a string describing the status; and the jqXHR (in jQuery 1.4.x, XMLHttpRequest) object. As of jQuery 1.5, the success setting can accept an array of functions. Each function will be called in turn. This is an Ajax Event.
	**/
	@:optional
	var success : TypeOrArray<global.jquery.ajax.SuccessCallback<TContext>>;
	/**
	...
	**/
	@:optional
	function xhr(unknown:Dynamic):js.html.XMLHttpRequest;
	/**
