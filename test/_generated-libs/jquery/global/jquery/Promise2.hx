...
typedef Promise2<TR, TJ, TN, UR, UJ, UN> = {
	...
	**/
	function always(unknown:Dynamic):Promise2<TR, TJ, TN, UR, UJ, UN>;
	/**
		Add handlers to be called when the Deferred object is resolved.
	**/
	function done(unknown:Dynamic):Promise2<TR, TJ, TN, UR, UJ, UN>;
	/**
		Add handlers to be called when the Deferred object is rejected.
	**/
	function fail(unknown:Dynamic):Promise2<TR, TJ, TN, UR, UJ, UN>;
	/**
		Add handlers to be called when the Deferred object generates progress notifications.
	**/
	function progress(unknown:Dynamic):Promise2<TR, TJ, TN, UR, UJ, UN>;
	/**
		Return a Deferred's Promise object.
	**/
	@:overload(function(unknown:Dynamic):Promise2<TR, TJ, TN, UR, UJ, UN> { })
