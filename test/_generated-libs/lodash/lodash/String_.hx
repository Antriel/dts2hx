...
typedef String_<T> = {
	function first(unknown:Dynamic):Null<String>;
	function flatten(unknown:Dynamic):Collection<String>;
	function head(unknown:Dynamic):Null<String>;
	function join(unknown:Dynamic):String;
	function last(unknown:Dynamic):Null<String>;
	function countBy(unknown:Dynamic):Object<Dictionary<Float>>;
	dynamic function each(unknown:Dynamic):String_<String>;
	dynamic function eachRight(unknown:Dynamic):String_<String>;
	function filter(unknown:Dynamic):Collection<String>;
	@:overload(function(unknown:Dynamic):Collection<String> { })
	...
	function forEach(unknown:Dynamic):String_<String>;
	function forEachRight(unknown:Dynamic):String_<String>;
	function groupBy(unknown:Dynamic):Object<Dictionary<Array<String>>>;
	function includes(unknown:Dynamic):Bool;
	function keyBy(unknown:Dynamic):Object<Dictionary<String>>;
	@:overload(function(unknown:Dynamic):Collection<String> { })
	function map<TResult>(unknown:Dynamic):Collection<TResult>;
	function partition(unknown:Dynamic):LoDashImplicitWrapper<ts.Tuple2<Array<String>, Array<String>>>;
	function reject(unknown:Dynamic):Collection<String>;
	function sample(unknown:Dynamic):Null<String>;
	function sampleSize(unknown:Dynamic):Collection<String>;
	function shuffle(unknown:Dynamic):Collection<String>;
	function castArray(unknown:Dynamic):Collection<String>;
	function toArray(unknown:Dynamic):Collection<String>;
	@:overload(function(unknown:Dynamic):String { })
	function get(unknown:Dynamic):String;
	function invertBy(unknown:Dynamic):Object<Dictionary<Array<String>>>;
	@:overload(function(unknown:Dynamic):Object<NumericDictionary<String>> { })
	function mapValues<TResult>(unknown:Dynamic):Object<NumericDictionary<TResult>>;
	function values(unknown:Dynamic):Collection<String>;
	function valuesIn(unknown:Dynamic):Collection<String>;
	function chain<T>(unknown:Dynamic):StringChain<T>;
	function iteratee(unknown:Dynamic):Function<(unknown:Dynamic) -> Dynamic>;
	...
	function forIn(unknown:Dynamic):String_<T>;
	function forInRight(unknown:Dynamic):String_<T>;
	function forOwn(unknown:Dynamic):String_<T>;
	function forOwnRight(unknown:Dynamic):String_<T>;
	...
	function set(unknown:Dynamic):String_<T>;
	@:overload(function<TResult>(unknown:Dynamic):ImpChain<TResult> { })
	function setWith(unknown:Dynamic):String_<T>;
	...
	function commit(unknown:Dynamic):String_<T>;
	function plant(unknown:Dynamic):String_<T>;
	function reverse(unknown:Dynamic):String_<T>;
	function toJSON(unknown:Dynamic):T;
	function value(unknown:Dynamic):T;
	function valueOf(unknown:Dynamic):T;
	function tap(unknown:Dynamic):String_<T>;
	...
	function bindAll(unknown:Dynamic):String_<T>;
	...
	function mixin(unknown:Dynamic):String_<T>;
