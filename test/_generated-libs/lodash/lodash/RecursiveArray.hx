...
typedef RecursiveArray<T> = {
	...
	**/
	function some(predicate:(value:ts.AnyOf2<RecursiveArray<T>, T>, index:Float, array:Array<ts.AnyOf2<RecursiveArray<T>, T>>) -> Any, ?thisArg:Dynamic):Bool;
	/**
	...
	**/
	function entries():js.lib.ArrayIterator<ts.Tuple2<Float, ts.AnyOf2<RecursiveArray<T>, T>>>;
	/**
	...
	**/
	function values():js.lib.ArrayIterator<ts.AnyOf2<RecursiveArray<T>, T>>;
};