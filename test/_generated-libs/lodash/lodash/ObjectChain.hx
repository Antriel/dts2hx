...
typedef ObjectChain<T> = {
	...
	@:overload(function<TKey, TDefault>(path:ts.AnyOf2<TKey, ts.Tuple1<TKey>>, defaultValue:TDefault):ts.AnyOf2<ExpChain<TDefault>, ExpChain<{ }>> { })
	...
	@:overload(function<TPath, TDefault>(path:TPath, defaultValue:TDefault):ts.AnyOf2<ExpChain<TDefault>, ExpChain<{ }>> { })
	@:overload(function(path:PropertyPath, ?defaultValue:Dynamic):LoDashExplicitWrapper<Dynamic> { })
	function get<TKey>(path:ts.AnyOf2<TKey, ts.Tuple1<TKey>>):ExpChain<Dynamic>;
	...
	@:overload(function<TSource1, TSource2>(source1:TSource1, source2:TSource2, customizer:(value:Dynamic, srcValue:Dynamic, key:String, object:Dynamic, source:Dynamic, stack:Dynamic) -> Dynamic):ObjectChain<Dynamic> { })
	@:overload(function<TSource1, TSource2, TSource3>(source1:TSource1, source2:TSource2, source3:TSource3, customizer:(value:Dynamic, srcValue:Dynamic, key:String, object:Dynamic, source:Dynamic, stack:Dynamic) -> Dynamic):ObjectChain<Dynamic> { })
	@:overload(function<TSource1, TSource2, TSource3, TSource4>(source1:TSource1, source2:TSource2, source3:TSource3, source4:TSource4, customizer:(value:Dynamic, srcValue:Dynamic, key:String, object:Dynamic, source:Dynamic, stack:Dynamic) -> Dynamic):ObjectChain<Dynamic> { })
	@:overload(function(otherArgs:haxe.extern.Rest<Dynamic>):ObjectChain<Dynamic> { })
	function mergeWith<TSource>(source:TSource, customizer:(value:Dynamic, srcValue:Dynamic, key:String, object:Dynamic, source:Dynamic, stack:Dynamic) -> Dynamic):ObjectChain<Dynamic>;
	@:overload(function(paths:haxe.extern.Rest<Many<PropertyName>>):ObjectChain<T> { })
	...
	@:overload(function(props:haxe.extern.Rest<Many<PropertyPath>>):ObjectChain<T> { })
	...
	@:overload(function<TResult>(iteratee:MemoVoidDictionaryIterator<Dynamic, Dynamic, TResult>, ?accumulator:TResult):ExpChain<TResult> { })
	@:overload(function():ExpChain<Dynamic> { })
	function transform<TResult>(iteratee:MemoVoidDictionaryIterator<Dynamic, String, TResult>, ?accumulator:TResult):ExpChain<TResult>;
	@:overload(function<TResult>(path:PropertyPath, updater:(oldValue:Dynamic) -> Dynamic, ?customizer:SetWithCustomizer<T>):ObjectChain<TResult> { })
	function updateWith(path:PropertyPath, updater:(oldValue:Dynamic) -> Dynamic, ?customizer:SetWithCustomizer<T>):ObjectChain<T>;
	...
	function set(path:PropertyPath, value:Dynamic):ObjectChain<T>;
	@:overload(function<TResult>(path:PropertyPath, value:Dynamic, ?customizer:SetWithCustomizer<T>):ExpChain<TResult> { })
	function setWith(path:PropertyPath, value:Dynamic, ?customizer:SetWithCustomizer<T>):ObjectChain<T>;
