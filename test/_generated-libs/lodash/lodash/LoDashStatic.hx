...
typedef LoDashStatic = {
	...
	**/
	@:overload(function<T, AnyList>(array:Null<RejectReadonly<AnyList>>, value:T):List_<T> { })
	@:overload(function<T, U>(array:Null<Array<U>>, value:T, ?start:Float, ?end:Float):Array<ts.AnyOf2<T, U>> { })
	@:overload(function<T, UList>(array:Null<RejectReadonly<UList>>, value:T, ?start:Float, ?end:Float):List_<ts.AnyOf2<T, Dynamic>> { })
	...
	**/
	@:overload(function<TList>(array:RejectReadonly<TList>, values:haxe.extern.Rest<Dynamic>):TList { })
	...
	**/
	@:overload(function<TList>(array:RejectReadonly<TList>, ?values:List_<Dynamic>):TList { })
	...
	**/
	@:overload(function<TList>(array:RejectReadonly<TList>, ?values:List_<Dynamic>, ?iteratee:ValueIteratee<Dynamic>):TList { })
	@:overload(function<T1, T2>(array:Array<T1>, values:List_<T2>, iteratee:ValueIteratee<ts.AnyOf2<T1, T2>>):Array<T1> { })
	@:overload(function<T1List, T2>(array:RejectReadonly<T1List>, values:List_<T2>, iteratee:ValueIteratee<ts.AnyOf2<T2, Dynamic>>):T1List { })
	...
	**/
	@:overload(function<TList>(array:RejectReadonly<TList>, ?values:List_<Dynamic>, ?comparator:Comparator<Dynamic>):TList { })
	@:overload(function<T1, T2>(array:Array<T1>, values:List_<T2>, comparator:Comparator2<T1, T2>):Array<T1> { })
	@:overload(function<T1List, T2>(array:RejectReadonly<T1List>, values:List_<T2>, comparator:Comparator2<Dynamic, T2>):T1List { })
	...
	**/
	@:overload(function<TList>(array:RejectReadonly<TList>, indexes:haxe.extern.Rest<Many<Float>>):TList { })
	...
	**/
	function remove<TList>(array:RejectReadonly<TList>, ?predicate:ListIteratee<Dynamic>):Array<Dynamic>;
	/**
	...
	**/
	function reverse<TList>(array:RejectReadonly<TList>):TList;
	/**
