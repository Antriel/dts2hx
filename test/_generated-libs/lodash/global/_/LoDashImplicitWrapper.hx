...
typedef LoDashImplicitWrapper<TValue> = {
	...
	function wrap<TArgs, TResult>(wrapper:(value:TValue, args:haxe.extern.Rest<TArgs>) -> TResult):Function<(args:haxe.extern.Rest<TArgs>) -> TResult>;
	...
	function forOwnRight(?iteratee:ObjectIterator<TValue, Dynamic>):LoDashImplicitWrapper<TValue>;
	...
	function set(path:PropertyPath, value:Dynamic):LoDashImplicitWrapper<TValue>;
	@:overload(function<TResult>(path:PropertyPath, value:Dynamic, ?customizer:SetWithCustomizer<TValue>):ImpChain<TResult> { })
	function setWith(path:PropertyPath, value:Dynamic, ?customizer:SetWithCustomizer<TValue>):LoDashImplicitWrapper<TValue>;
	...
	function commit():LoDashImplicitWrapper<TValue>;
	function plant(value:Any):LoDashImplicitWrapper<TValue>;
	function reverse():LoDashImplicitWrapper<TValue>;
	function toJSON():TValue;
	function value():TValue;
	function valueOf():TValue;
	function tap(interceptor:(value:TValue) -> Void):LoDashImplicitWrapper<TValue>;
	function thru<TResult>(interceptor:(value:TValue) -> TResult):ImpChain<TResult>;
	...
	function bindAll(methodNames:haxe.extern.Rest<Many<String>>):LoDashImplicitWrapper<TValue>;
	function conforms():Function<(value:{ }) -> Bool>;
	function constant():Function<() -> TValue>;
	@:overload(function<TDefault>(defaultValue:TDefault):Dynamic { })
	function defaultTo(defaultValue:TValue):TValue;
	function identity():TValue;
	...
	function mixin(source:Dictionary<(args:haxe.extern.Rest<Dynamic>) -> Dynamic>, ?options:MixinOptions):LoDashImplicitWrapper<TValue>;
