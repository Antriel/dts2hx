...
typedef LoDashImplicitWrapper<TValue> = {
	...
	function clone(unknown:Dynamic):TValue;
	function cloneDeep(unknown:Dynamic):TValue;
	@:overload(function(unknown:Dynamic):TValue { })
	function cloneDeepWith(unknown:Dynamic):Dynamic;
	@:overload(function<TResult>(unknown:Dynamic):ts.AnyOf2<TValue, TResult> { })
	@:overload(function(unknown:Dynamic):TValue { })
	...
	function forIn(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function forInRight(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function forOwn(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function forOwnRight(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	...
	function set(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	@:overload(function<TResult>(unknown:Dynamic):ImpChain<TResult> { })
	function setWith(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	...
	function commit(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function plant(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function reverse(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function toJSON(unknown:Dynamic):TValue;
	function value(unknown:Dynamic):TValue;
	function valueOf(unknown:Dynamic):TValue;
	function tap(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	...
	function bindAll(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
	function conforms(unknown:Dynamic):Function<(unknown:Dynamic) -> Bool>;
	function constant(unknown:Dynamic):Function<(unknown:Dynamic) -> TValue>;
	@:overload(function<TDefault>(unknown:Dynamic):Dynamic { })
	function defaultTo(unknown:Dynamic):TValue;
	function identity(unknown:Dynamic):TValue;
	...
	function mixin(unknown:Dynamic):LoDashImplicitWrapper<TValue>;
