...
**/
typedef SlashCommandOptionsOnlyBuilder = {
	/**
	...
	**/
	function setName(name:String):SlashCommandOptionsOnlyBuilder;
	/**
		Sets the description of this command.
	**/
	function setDescription(description:String):SlashCommandOptionsOnlyBuilder;
	/**
		Sets a name localization for this command.
	**/
	function setNameLocalization(locale:String, localizedName:Null<String>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets the name localizations for this command.
	**/
	function setNameLocalizations(localizedNames:Null<{ @:optional var id : Dynamic; @:optional @:native("en-US") var en_US : Dynamic; @:optional @:native("en-GB") var en_GB : Dynamic; @:optional var bg : Dynamic; @:optional @:native("zh-CN") var zh_CN : Dynamic; @:optional @:native("zh-TW") var zh_TW : Dynamic; @:optional var hr : Dynamic; @:optional var cs : Dynamic; @:optional var da : Dynamic; @:optional var nl : Dynamic; @:optional var fi : Dynamic; @:optional var fr : Dynamic; @:optional var de : Dynamic; @:optional var el : Dynamic; @:optional var hi : Dynamic; @:optional var hu : Dynamic; @:optional var it : Dynamic; @:optional var ja : Dynamic; @:optional var ko : Dynamic; @:optional var lt : Dynamic; @:optional var no : Dynamic; @:optional var pl : Dynamic; @:optional @:native("pt-BR") var pt_BR : Dynamic; @:optional var ro : Dynamic; @:optional var ru : Dynamic; @:optional @:native("es-ES") var es_ES : Dynamic; @:optional @:native("es-419") var es_419 : Dynamic; @:optional @:native("sv-SE") var sv_SE : Dynamic; @:optional var th : Dynamic; @:optional var tr : Dynamic; @:optional var uk : Dynamic; @:optional var vi : Dynamic; }>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets a description localization for this command.
	**/
	function setDescriptionLocalization(locale:String, localizedDescription:Null<String>):SlashCommandOptionsOnlyBuilder;
	/**
	...
	**/
	function setContexts(contexts:haxe.extern.Rest<Any>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets the integration types of this command.
	**/
	function setIntegrationTypes(integrationTypes:haxe.extern.Rest<Any>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets whether the command is enabled by default when the application is added to a guild.
	**/
	function setDefaultPermission(value:Bool):SlashCommandOptionsOnlyBuilder;
	/**
		Sets the default permissions a member should have in order to run the command.
	**/
	function setDefaultMemberPermissions(permissions:Null<ts.AnyOf3<String, Float, js.lib.BigInt>>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets if the command is available in direct messages with the application.
	**/
	function setDMPermission(enabled:Null<Bool>):SlashCommandOptionsOnlyBuilder;
	/**
		Sets whether this command is NSFW.
	**/
	function setNSFW(?nsfw:Bool):SlashCommandOptionsOnlyBuilder;
	/**
