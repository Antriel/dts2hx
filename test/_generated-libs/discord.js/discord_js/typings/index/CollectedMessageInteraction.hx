...
typedef CollectedMessageInteraction<Cached> = ts.AnyOf7<StringSelectMenuInteraction<Cached>, UserSelectMenuInteraction<Cached>, RoleSelectMenuInteraction<Cached>, MentionableSelectMenuInteraction<Cached>, ChannelSelectMenuInteraction<Cached>, ButtonInteraction<Cached>, {
	var type : Int;
	...
	var message : Null<Message<BooleanCache<Cached>>>;
	var replied : Bool;
