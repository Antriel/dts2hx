...
**/
@:jsRequire("discord.js/typings/index", "SlashCommandSubcommandGroupBuilder") extern class SlashCommandSubcommandGroupBuilder {
	function new();
	/**
	...
	**/
	...
	static var prototype : SlashCommandSubcommandGroupBuilder;
}