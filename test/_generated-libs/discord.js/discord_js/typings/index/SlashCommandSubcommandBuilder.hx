...
**/
@:jsRequire("discord.js/typings/index", "SlashCommandSubcommandBuilder") extern class SlashCommandSubcommandBuilder {
	function new();
	/**
	...
	**/
	...
	static var prototype : SlashCommandSubcommandBuilder;
}