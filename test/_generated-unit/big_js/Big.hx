...
@:jsRequire("big.js", "Big") extern class Big {
	...
	**/
	function abs(unknown:Dynamic):Big;
	/**
		Returns a Big number whose value is the value of this Big number plus n - alias for .plus().
	**/
	function add(unknown:Dynamic):Big;
	/**
		Compare the values.
	**/
	function cmp(unknown:Dynamic):Comparison;
	/**
	...
	**/
	function div(unknown:Dynamic):Big;
	/**
	...
	**/
	function minus(unknown:Dynamic):Big;
	/**
	...
	**/
	function pow(unknown:Dynamic):Big;
	/**
		Returns a Big number whose value is the value of this Big number rounded using rounding mode rm to a maximum of dp decimal places.
	**/
	function round(unknown:Dynamic):Big;
	/**
		Returns a Big number whose value is the square root of this Big number.
		
		If the result has more fraction digits than is specified by Big.DP, it will be rounded to Big.DP decimal places using rounding mode Big.RM.
	**/
	function sqrt(unknown:Dynamic):Big;
	/**
		Returns a Big number whose value is the value of this Big number minus n - alias for .minus().
	**/
	function sub(unknown:Dynamic):Big;
	/**
		Returns a Big number whose value is the value of this Big number times n.
	**/
	function times(unknown:Dynamic):Big;
	/**
	...
	**/
	...
	/**
		...
		String values in octal literal form will be interpreted as decimals, e.g. '011' is 11, not 9.
	**/
	@:overload(function(unknown:Dynamic):BigConstructor { })
	@:selfCall
	static function call(unknown:Dynamic):Big;
	/**
